...
csv_file_img = "/work3/s206182/projects/detecting_causes_of_gender_bias_chest_xrays/prediction/run/chexpert-Pleural Effusion-fp50-npp1-rs0-image_size224/train.version_0.csv" 
image_size = 224
pseudo_rgb = True
batch_size = 32
num_workers = 4
