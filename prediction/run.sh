...
python3 ./disease_prediction.py -s chexpert -d 'Pleural Effusion' -f 50 -n 'none' -r 0 -p '/work3/s206182/dataset/' --flip 'false' --save_model 'true' --epochs 50 --model_scale '18'
